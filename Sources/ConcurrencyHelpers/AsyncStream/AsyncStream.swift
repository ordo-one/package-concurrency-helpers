...
public struct AsyncStreamBP<Element> {
...
@available(SwiftStdlib 5.1, *)
extension AsyncStreamBP: AsyncSequence {
...
@available(SwiftStdlib 5.1, *)
extension AsyncStreamBP.Continuation {
  /// Resume the task awaiting the next iteration point by having it return
...
extension AsyncStreamBP {
  ...
  public static func makeStream(
      ...
      bufferingPolicy limit: Continuation.BufferingPolicy = .unbounded
  ) -> (stream: AsyncStreamBP<Element>, continuation: AsyncStreamBP<Element>.Continuation) {
    var continuation: AsyncStreamBP<Element>.Continuation!
    let stream = AsyncStreamBP<Element>(bufferingPolicy: limit) { continuation = $0 }
    return (stream: stream, continuation: continuation!)
  }
}

@available(SwiftStdlib 5.1, *)
extension AsyncStreamBP: @unchecked Sendable where Element: Sendable { }
#else
@available(SwiftStdlib 5.1, *)
